...
import { Input, Row, Col, Card, Collapse, Tooltip, Button, Tag, Divider } from 'antd';
...
const Testing = ({ title, value, status, subtitle, prefix }) => {
  ...
  // const [ThreeCardsDataOnly, setThreeCardsDataOnly] = useState([
  //   {
  //     key: "on_board_tasks",
  //     title: "On Board",
  //     threedata:[
  ...
  // ])
    ...
    // const [threeCurrentCategory, setThreeCurrentCategory] = useState({
    //   threeCardCurrentCategory:'on_board_tasks'
    // })
    ...
    //     let i = tableParams.pagination.current - 1;
    //     return (index) => {
    //         return i = i + 1;
    //     };
    // };
              ...
              alldata:[{
                ...
                columnName:[
                  ...
                  render: (on_status) => {
                    ...
                    const statusIcon = on_status !== 0 && on_status > 0 ? <ArrowUpOutlined /> : <ArrowDownOutlined />;
                    return (
<>
                      ...
                      {on_status}
                      <span className={`font-size-md font-weight-bold ml-1 ${on_status !== 0 && on_status > 0 ? 'text-success' : 'text-danger'}`} >{statusIcon}</span>
                  ...
                  },
                  {
                    ...
                    <div className="text-right d-flex ">
                      <Button.Group>
                        <Tooltip title="View">
                          <Button type="primary" className='mx-0' icon={<EyeOutlined />} onClick={() => HandleViewPendingTask(elm)} size="small" style={{boxShadow:"none"}}/>
                        </Tooltip>
                        </Button.Group>
                      </div>
                    )
                  ...
                  },
                  {
                    ...
                    render: (elm) => (
                      <div className="text-right d-flex ">
                        <Button.Group>
                          <Tooltip title="View">
                            <Button type="primary" className='mx-0' icon={<EyeOutlined />} onClick={()=>HandleViewOverdeuTask(elm)} size="small" style={{boxShadow:"none"}}/>
                          </Tooltip>
                          </Button.Group>
                        </div>
                      )
