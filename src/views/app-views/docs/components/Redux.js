	...
	return (
		<>{someStateFromYourSlice}</>
			...
			<div className="mt-4">
				...
				<p className="mt-1">Slice is a collection of reducer logic and actions for a single feature, hence we sugguest to place slice file under your features module folder for better logic scoping. Here is a basic example of a slice.</p>
				<SyntaxHighlighter className="hl-code" language="javascript" style={atomDark}>
...
export default yourSlice.reducer`}
			...
			<div className="mt-4">
				...
				<p className="mt-1">You can also make an API request with <code>createAsyncThunk</code> via extraReducers</p>
				<SyntaxHighlighter className="hl-code" language="javascript" style={atomDark}>
