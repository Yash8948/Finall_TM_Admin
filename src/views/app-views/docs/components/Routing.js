	...
	return (
		<div>
			...
			<div className="mt-4">
				...
				<p className="my-1">You can find the template's router configuration in <code>src/configs/RoutesConfig.js</code>, there's 2 type of route group as following.</p>
				<ul>
					<li><strong>publicRoutes</strong><p className="mt-1">this routes group included all routes that open to all users.</p></li>
					<li><strong>protectedRoutes</strong><p className="mt-1">This routes group included all routes that required authentication.</p></li>
				</ul>
			</div>
			<div className="mt-4">
